    ...
    <div class=wrapper-body>
        <header class=s-header>
            ...
            <div class=button-wrapper>
                <div class=container>
                    <div class=row> <a href=# class=btn-content>church gallery</a> </div>
                </div>
            </div>
        </header>
        <section class=gallery-page-wrapper>
            <div class=container>
                <ul class=menu-wrapper id=menu>
                    <li><a href=#menu class="headline-lato selected">show all</a></li>
                    <li><a href=#menu data-filter=.image class=headline-lato>images</a></li>
                    <li><a href=#menu data-filter=.link class=headline-lato>links</a></li>
                    <li><a href=#menu data-filter=.slideshow class=headline-lato>slideshow</a></li>
                    <li><a href=#menu data-filter=.video class=headline-lato>video</a></li>
                </ul>
                <div class=row>
                    <div class="wrapper isp-wrap">
                        ...
                        <div class=btn-load> <a class="btn btn-grey">load more</a> </div>
                    </div>
                </div>
            </div>
        </section>
