    ...
    <div class="wrapper-body event-pg">
        ...
        <header class=s-header>
            ...
            <div class=button-wrapper>
                <div class=container>
                    <div class=row> <a href=# class=btn-content>Devenez partenaire</a></div>
                </div>
            </div>
        </header>
        <section class="gallery-page-wrapper Actualités">
            <div class=container>
                <ul class=menu-wrapper id=menu>
                    <li><a href=#menu data-filter=* class="headline-lato selected">Sélectionner tout</a></li>
                    <li><a href=#menu data-filter=.Celebrations class=headline-lato>Célébrations</a></li>
                    <li><a href=#menu data-filter=.Fests class=headline-lato>Fêtes</a></li>
                    <li><a href=#menu data-filter=.Meetings class=headline-lato>Réunions</a></li>
                    <li><a href=#menu data-filter=.Prayers class=headline-lato>Prières</a></li>
                </ul>
                <div class=row>
