    ...
    <div class="wrapper-body event-pg">
        <div class=overlay-event>
            <div class="modal-event clearfix">
                ...
                <form>
                    ...
                    <div class=form-group> <input type=email class="form-control text" placeholder="email (required)">
                    </div>
                    <div class=button-register> <button type=submit class=submit>Register</button> </div>
                </form>
            </div>
        </div>
        <header class=s-header>
            ...
            <div class=button-wrapper>
                <div class=container>
                    <div class=row> <a href=# class=btn-content>Event grids</a> </div>
                </div>
            </div>
        </header>
        <section class="gallery-page-wrapper Actualités">
            <div class=container>
                <ul class=menu-wrapper id=menu>
                    <li><a href=#menu data-filter=* class="headline-lato selected">select all</a></li>
                    <li><a href=#menu data-filter=.Celebrations class=headline-lato>Celebrations</a></li>
                    <li><a href=#menu data-filter=.Fests class=headline-lato>Fests</a></li>
                    <li><a href=#menu data-filter=.Meetings class=headline-lato>Meetings</a></li>
                    <li><a href=#menu data-filter=.Prayers class=headline-lato>Prayers</a></li>
                </ul>
                <div class=row>
                                ...
                                <div class="item clearfix"> <a class=item-img href=event_details.php> <img
                                    ...
                                    <div class=item-content>
                                        ...
                                        <div class="item-footer clearfix">
                                            ...
                                            <div class=footer-button> <a
                                                    class="btn-middle btn-lightGrey open-register">register</a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
