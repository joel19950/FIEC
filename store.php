    ...
    <div class=wrapper-body>
        <header class=s-header>
                                ...
                                <div class=nav-wrapper>
                                    ...
                                    <div class=nav-menu> <a href=# class=close> <i class="fa fa-times"></i> </a>
                                        <ul class="nav navbar-nav menu-bar">
                                            ...
                                            <!-- <li><a href=store.php class=active>Télécharger</a></li> -->
            ...
            <div class=button-wrapper>
                <div class=container>
                    <div class=row> <a href=# class=btn-content>Téléchargement</a> </div>
                </div>
            </div>
        </header>
        <section class=store>
                        ...
                        <aside class="content clearfix">
                            <div class=figure>
                                <div class=item>
                                    ...
                                    <div class=item-content>
                                        <div class="item-header clearfix"> <span class=headline-lato>candles</span>
                                            <span>$100</span>
                                        </div>
                            ...
                            <div class=figure>
                                <div class=item>
                                    ...
                                    <div class=item-content>
                                        <div class="item-header clearfix"> <span class=headline-lato>book</span>
                                            <span>$262</span>
                                        </div>
                                        <p>Lorem Ipsum is simply dummy text of the printing.</p>
                                    </div>
                            ...
                            <div class=figure>
                                <div class=item>
                                    <div class=item-img> <img src=images/content/glass.jpg alt=image>
                                        <div class=item-cart> <a href=store_details.php>Add to cart</a> </div>
                                    </div>
                                    <div class=item-content>
                                        <div class="item-header clearfix"> <span class=headline-lato>candle</span>
                                            <span>$195</span>
                                        </div>
                                        <p>Lorem Ipsum is simply dummy text of the printing.</p>
                                    </div>
