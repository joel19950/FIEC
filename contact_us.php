  ...
  <div class=wrapper-body>
    <header class=s-header>
      ...
      <div class=menu>
        <div class=container>
          <div class=row>
            <div class=header-top-left> <a href=index.php class=logo> <img src=images/logo.png alt=image-logo> </a>
            </div>
                ...
                <div class=nav-wrapper>
                    ...
                    <div class=nav-menu> <a href=# class=close> <i class="fa fa-times"></i> </a>
                        <ul class="nav navbar-nav menu-bar">
                            ...
                            <li><a href=contact_us.php class=active>Contacts</a></li>
      ...
      <div class=button-wrapper>
        <div class=container>
          <div class=row> <a href=# class=btn-content>Contacts</a> </div>
        </div>
      </div>
    </header>
    <section class=store>
            ...
            <aside class="content contact-wrap">
              ...
              <div class="contact-form clearfix">
                <form method=post name=contact id=contact>
                  <div class=form-group> <input type=text class="form-control text" id=name name=name
                      placeholder="Your name"> </div>
                  <div class=form-group> <input type=email class="form-control text" id=eml name=eml
                      placeholder="Your E-mail"> </div>
                  <div class=form-group> <input type=text class="form-control text" id=phone name=phone
                      placeholder=Phone> </div>
                  <div class=form-group1> <textarea class="form-control texta" id=comment name=comment
                      placeholder=Message></textarea> </div> <button class=submit>send message</button>
              ...
              <div class=contact-address>
                <p class=paragraph_opensans>Organisé par l'association des Batisseurs et entrepreneurs 
                 Chretiens pour le developpement social</p>
                <div class="fig-addrs clearfix">
                  <p>Téléphone:</p>
                  <div class=address-cont> <i class="fa fa-phone"></i> <span>+237 675 40 72 40 <br>+237 675 40 72 40</span>
                  </div>
                </div>
                <div class="fig-addrs clearfix">
                  <p>Email:</p>
                  <div class=address-cont> <i class="fa fa-envelope"></i> <span>fiec237@yahoo.com</span> </div>
                </div>
                <div class="fig-addrs clearfix">
                  <p>Adresse:</p>
                  <div class=address-cont> <i class="fa fa-map-marker"></i> <span>Espalanade de la maison, du parti de Bonanjo,<br>Douala - Cameroun
                      </span> </div>
                </div>
  ...
  <script>
    ...
    function initialize() {
      var mapOptions = {
        zoom: 12,
        scrollwheel: false,
        center: new google.maps.LatLng(40.590034, -73.940101),
        panControl: false,
        zoomControl: false,
        styles: [
      ...
      /*----------------------------------------------------*/
        $("#contact").validate({ 
          ...
          submitHandler: function (form) { 
            ...
            var data={'formid':'contact','cust_name':cName,'cust_phone':cphn,'comments':cComment,'cust_email':cEml};
            console.log(data);
            $.post(suburl ,  data , function(response){
              $('.contact-page-form').php(response);
