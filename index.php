    ...
    <div class=wrapper-body>
            ...
            <div class=container>
                <div class=row>
                    ...
                    <ul class="right-fig js-countdown clearfix">
                        <li>
                            <h5>Étude biblique du pasteur</h5>
                            <h6>23 mars, 2021 </h6>
                        </li>
                        ...
                        <li> <a href=# class="btn red-btn"> Actualités</a> </li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <footer>
            <div class=container>
                ...
                <h6>&copy; 2021 FIEC Powered by <a href="http://itobuz.com/" target=_blank><span>fiec.com</span></a>
                </h6>
            </div>
        </footer>
    </div>
